...
/**
 * Created by Keith on 11/20/16.
 *
 * TODO: Modify for one controller use
 */

public class SingleControllerControls implements ControllerConfig
{
    Gamepad gamepad1;
    Gamepad gamepad2;
    public SingleControllerControls(Gamepad gamepad1, Gamepad gamepad2) {
