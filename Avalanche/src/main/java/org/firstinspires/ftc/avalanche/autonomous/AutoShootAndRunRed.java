...
@Autonomous(name = "AutoShootAndRunRed", group = "Autonomous")
public class AutoShootAndRunRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        autoDriveTrain.moveDistanceAtSpeedOnHeading(.6, -26, 0);
        launchOneBall();
        Thread.sleep(1000);
        loadAndLaunch();
        Thread.sleep(3000);
        autoDriveTrain.moveDistanceAtSpeedOnHeading(.6, -30, 0);
    }
